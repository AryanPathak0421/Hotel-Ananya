            ...
            <section className="bg-secondary relative h-56 overflow-hidden group active:scale-[0.99] transition-all">
                ...
                <div className="relative z-10 h-full p-8 flex flex-col justify-end space-y-3">
                    <div className="flex items-center space-x-2">
                        ...
                        <span className="text-primary font-black uppercase tracking-[0.4em] text-[8px]">{tag}</span>
                    </div>
                    ...
                    <div className="flex space-x-4 pt-2">
                        <button
                            ...
                            className="text-white text-[9px] font-black uppercase tracking-widest border-b border-white/30 pb-1 flex items-center group/btn transition-all active:scale-95"
                        >
    ...
    return (
        <section className="bg-secondary relative h-48 overflow-hidden group active:scale-[0.99] transition-all cursor-pointer" onClick={() => navigate(path)}>
            ...
            <div className="relative z-10 h-full p-6 flex flex-col justify-center space-y-2">
                <span className="text-primary font-black uppercase tracking-[0.3em] text-[8px]">{tag}</span>
                ...
                <button
                    ...
                    className="mt-2 bg-primary text-white text-[9px] font-black uppercase tracking-widest px-6 py-2.5 rounded-lg w-fit shadow-lg shadow-primary/20 hover:scale-105 hover:bg-white hover:text-primary transition-all active:scale-95"
                >
                    {btnText}
                </button>
            </div>
